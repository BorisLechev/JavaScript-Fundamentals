function censorship(text, array) {
    for (let arrayElement of array) {
        text = text
            .split(arrayElement)
            .join("-".repeat(arrayElement.length));
    }
...
censorship('David Ruben Piqtoukun (born 1950) is an Inuit artist from Paulatuk,' +
    ...
    ' modern and traditional Inuit stylistic elements in a personal vision. An example of this' +
    ' is his work "The Passage of Time" (1999), which portrays a shaman in the form of a salmon' +
    ' moving through a hole in a hand. While shamanic imagery is common in much of Inuit art, the hand' +
    ' in this work is sheet metal, not a traditional material such as walrus ivory, caribou antler or soapstone.' +
